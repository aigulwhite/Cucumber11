...
//=========================================================   positive scenarios above; negative-below this line
...
//    @When("the user provides wrong username and password")                 // hard coding, unprofessional
//    public void the_user_provides_wrong_username_and_password() {
//        loginPage.login("ahmet", "baldir");
//
//    }
    @When("the user provides wrong {string} and {string}")                 // dynamic, professional
